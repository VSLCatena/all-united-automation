...
const synchronise = async (req: Request, res: Response) => {
    ...
    res.send("Synchronisation complete!");
}
...
const navigateToAllMembersPage = async (driver: WebDriver) => {
...
const downloadMemberFile = async (driver: WebDriver) => {
